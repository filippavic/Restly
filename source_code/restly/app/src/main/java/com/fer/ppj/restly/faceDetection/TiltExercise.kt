...
class TiltExercise : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        animation_view.setAnimation(R.raw.tilt)
        Handler().postDelayed({
            exercise_animation.startAnimation(AnimationUtils.loadAnimation(this@TiltExercise, R.anim.fade_out_anim))
            exercise_animation.visibility= View.GONE
        }, 6000)

        tv_hint.text = getString(R.string.tilt_exc)
